"""
Generic fixed-length character-level preprocessing for reasoning tasks.
...
def parse_args():
    parser = argparse.ArgumentParser(description='Generic data preparation for fixed-length reasoning tasks')

    # Input/output paths.
    parser.add_argument('--data_path', type=str, default='data/3sat7_train.jsonl', help='Path to cd5 JSONL file')
    parser.add_argument('--out_dir', type=str, default='data/sat/3sat7/k8', help='Output directory for processed data')
